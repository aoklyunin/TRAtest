...
def getG(qList):
    ...
    return [0, 2.362139999011447302225668448683 * cos(q2 + q3 + 3.04) + 0.21958444029937820851650087661255 * sin(
     ...
     0.20351009246408627295643611887499 * cos(q2 + q3 + 3.04) * cos(q4) - 0.20351009246408627295643611887499 * sin(
         q2 + q3 + 3.04) * sin(q4)) + sin(q5 - 1.6) * (
     0.0071620057083474769621389555140922 * cos(q2 + q3 + 3.04) * cos(q4) - 0.0071620057083474769621389555140922 * sin(
