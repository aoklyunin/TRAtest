...
class Frame(wx.Frame):
    ...
    def initGrid(self):
        ...
        # задаём имена строк
        self.myGrid.SetRowLabelValue(0, "arm_joint_1")
        self.myGrid.SetRowLabelValue(1, "arm_joint_2")
        self.myGrid.SetRowLabelValue(2, "arm_joint_3")
        self.myGrid.SetRowLabelValue(3, "arm_joint_4")
        self.myGrid.SetRowLabelValue(4, "arm_joint_5")
        self.myGrid.SetRowLabelValue(5, "gripper_finger_joint_r")
        self.myGrid.SetRowLabelValue(6, "gripper_finger_joint_l")
